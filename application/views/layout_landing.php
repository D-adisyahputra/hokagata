...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo base_url() . 'assets/assets-landing/image/icon-3.png' ?>" />
        ...
        <header class="header">
            ...
            <div class="header-content">
                <div class="header-logo">
                    <img src="<?= base_url() . 'assets/assets-landing/image/logo-11.png' ?>" alt="">
                </div>
        ...
        <footer style="margin-top: 20px;" class="footer">
            <div class="wrapper">
                <div class="footer-copy">
                    <span>&copy; All rights reserved. Hokagata 2025</span>
                </div>
            </div>
        </footer>
