...
<body>
    <div style="text-align: center;">
        <img src="<?php echo base_url() . 'assets/assets-admin/images/logo/logo-11.png' ?>" width="200px" height="100px" />
    </div>
    <h1 style="text-align: center;">CETAK LAPORAN WEDDING ORGANIZER</h1>
    <div class="row" style="padding: 20px;">
        <div class=" col-6">
            <div>Hokagata Wedding Organizer</div>
            <div>Blang Pulo, Muara Satu, Kota Lhokseumawe</div>
        </div>
        <div class=" col-6" style="text-align: right;">
            <!-- <div> </div> -->
            <div>Lhokseumawe</div>
            <div>0837 2221 3334</div>
            <div></div>
        </div>
    </div>
