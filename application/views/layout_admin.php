...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" href="<?php echo base_url() . 'assets/assets-landing/image/icon-3.png' ?>">
    <link rel="shortcut icon" href="<?php echo base_url() . 'assets/assets-landing/image/icon-3.png' ?>">
                ...
                <div class="header-container">
                    <div class="nav-logo">
                        <a href="<?= base_url('admin') ?>">
                            <div class="logo" style="background-image: url('<?php echo base_url() . 'assets/assets-admin/images/logo/logo-11.png' ?>')"></div>
                        </a>
                    </div>
                    <ul class="nav-left">
                        <li>
